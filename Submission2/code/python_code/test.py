...
cifar10_dir = '/home/ratnesh/Desktop/PPCA-master/data/'
...
plt.hist(list(reconstruction_error_relative), bins = 100, color="#3F5D7D")
plt.show()
plt.savefig('err_recon_ppca.png')
